...
test('renders Carlist must show list of all car', () => {
  render(<Carlist list={mockList} onAdd={() => {() => {}}} />);
  const buttonPlus = screen.getByTestId('button_0_plus')
  fireEvent.click(buttonPlus)
  const buttonMinus = screen.getByTestId('button_0_minus')
